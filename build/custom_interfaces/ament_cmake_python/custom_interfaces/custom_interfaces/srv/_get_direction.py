...
class GetDirection_Response(metaclass=Metaclass_GetDirection_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.compass = kwargs.get('compass', str())
    ...
    def compass(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'compass' field must be of type 'str'"
        self._compass = value
...
class Metaclass_GetDirection(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.GetDirection')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _get_direction
...
class GetDirection(metaclass=Metaclass_GetDirection):
    from custom_interfaces.srv._get_direction import GetDirection_Request as Request
    from custom_interfaces.srv._get_direction import GetDirection_Response as Response

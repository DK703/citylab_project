...
#include "custom_interfaces/srv/detail/get_direction__rosidl_typesupport_fastrtps_c.h"
...
using _GetDirection_Request__ros_msg_type = custom_interfaces__srv__GetDirection_Request;
...
size_t get_serialized_size_custom_interfaces__srv__GetDirection_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetDirection_Request__ros_msg_type * ros_message = static_cast<const _GetDirection_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GetDirection_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__srv__GetDirection_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__srv__GetDirection_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__srv__GetDirection_Request;
    is_plain =
      (
...
static size_t _GetDirection_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__srv__GetDirection_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, GetDirection_Request)() {
...
#include "rosidl_runtime_c/string.h"  // compass, direction, info
#include "rosidl_runtime_c/string_functions.h"  // compass, direction, info

// forward declare type support functions


using _GetDirection_Response__ros_msg_type = custom_interfaces__srv__GetDirection_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: compass
  {
    const rosidl_runtime_c__String * str = &ros_message->compass;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: compass
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->compass.data) {
      rosidl_runtime_c__String__init(&ros_message->compass);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->compass,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'compass'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__srv__GetDirection_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetDirection_Response__ros_msg_type * ros_message = static_cast<const _GetDirection_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__srv__GetDirection_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__srv__GetDirection_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__srv__GetDirection_Response;
    is_plain =
      (
      offsetof(DataType, compass) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GetDirection_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__srv__GetDirection_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, GetDirection_Response)() {
...
// already included above
// #include "custom_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_interfaces/srv/get_direction.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, GetDirection)() {
